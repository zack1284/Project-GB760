...
#define how to remove the pecial characters
...
def uniquewordcount(readtxt):
  readlist = readtxt.strip().split()
  unique = []
...
#count distint words in the file
open_file=open("tweet.txt")
file_tweet =open_file.read()
file_tweet = clean_text(file_tweet)
unique_word = uniquewordcount(file_tweet)
